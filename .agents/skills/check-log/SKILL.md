...
2. **Fetch logs** using `run_command`:
...
3. **Diagnose** the output:
   ...
   - Use `view_file` to read the relevant source code to understand the failure.
...
4. **Report** findings:
   ...
   - If the fix is straightforward, implement it. Do NOT output modified code in chat — just list the files modified.
