...
4. **GitBook Formatting:** For specific rules on GitBook Markdown syntax (e.g., custom blocks, frontmatter, variables), always consult `knowledge/standards/gitbook.md`.
